...
class Api
{
    ...
    public static function call(string $controller,string $method,array $parameters = [],bool $nohup = false,$logFile = '',$userId = 0) : array
    {
        ...
        $api = 'sudo java -Dfile.encoding=UTF8 -jar ' . API_PATH . DS . 'khmissiown.jar';
 ...
 /**
     * @name calln1
     * @description calln1 iresponse api
     * @access public
     * @return array
     */ 
    public static function calln1(string $controller,string $method,array $parameters = [],bool $nohup = false,$logFile = '',$userId = 0) : array
    {
        # set the current application to a local variable
        $app = Application::getCurrent();
        ...
        # prepare info to call our api
        $api = 'sudo java -Dfile.encoding=UTF8 -jar ' . API_PATH . DS . 'khmissiautoreponder.jar';
        $userId = $userId == 0 ? intval(Authentication::getAuthenticatedUser()->getId()) : $userId;
